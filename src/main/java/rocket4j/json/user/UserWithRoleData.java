...
@Value.Immutable
@JsonSerialize(as = ImmutableUserWithRoleData.class)
@JsonDeserialize(as = ImmutableUserWithRoleData.class)
public interface UserWithRoleData {
    Optional<RoleData> roles();
}
