...
@Value.Immutable
@JsonSerialize(as = ImmutableInstantMessageUserData.class)
@JsonDeserialize(as = ImmutableInstantMessageUserData.class)
@SuppressWarnings("immutables:subtype")
public interface InstantMessageUserData extends BaseUserData, UserWithRoleData {
