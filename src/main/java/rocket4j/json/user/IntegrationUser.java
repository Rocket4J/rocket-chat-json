...
@Value.Immutable
@JsonSerialize(as = ImmutableIntegrationUser.class)
@JsonDeserialize(as = ImmutableIntegrationUser.class)
@SuppressWarnings("immutables:subtype")
public interface IntegrationUser extends MinimalUser, RoleUser {
