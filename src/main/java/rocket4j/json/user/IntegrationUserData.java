...
@Value.Immutable
@JsonSerialize(as = ImmutableIntegrationUserData.class)
@JsonDeserialize(as = ImmutableIntegrationUserData.class)
@SuppressWarnings("immutables:subtype")
public interface IntegrationUserData extends BaseUserData {
