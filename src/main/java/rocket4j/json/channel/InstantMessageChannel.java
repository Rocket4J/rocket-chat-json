...
@Value.Immutable
@JsonSerialize(as = ImmutableInstantMessageChannel.class)
@JsonDeserialize(as = ImmutableInstantMessageChannel.class)
@SuppressWarnings("immutables:subtype")
public interface InstantMessageChannel extends MinimalChannel {
