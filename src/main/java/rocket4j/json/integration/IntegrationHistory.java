...
import rocket4j.json.user.IntegrationUser;

@Value.Immutable
@Value.Enclosing
@JsonSerialize(as = ImmutableIntegrationHistory.class)
@JsonDeserialize(as = ImmutableIntegrationHistory.class)
public interface IntegrationHistory {
    ...
    @Value.Immutable
    @JsonSerialize(as = ImmutableIntegrationHistory.Data.class)
    @JsonDeserialize(as = ImmutableIntegrationHistory.Data.class)
    interface Data {
