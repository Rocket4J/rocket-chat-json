...
@Value.Immutable
@JsonSerialize(as = ImmutableSearchMessageData.class)
@JsonDeserialize(as = ImmutableSearchMessageData.class)
@SuppressWarnings("immutables:subtype")
public interface SearchMessageData extends MessageData {
