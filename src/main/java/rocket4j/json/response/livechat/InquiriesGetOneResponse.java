...
@Value.Immutable
@JsonSerialize(as = ImmutableInquiriesGetOneResponse.class)
@JsonDeserialize(as = ImmutableInquiriesGetOneResponse.class)
@SuppressWarnings("immutables:subtype")
public interface InquiriesGetOneResponse extends Response {
