...
@Value.Immutable
@JsonSerialize(as = ImmutableUpdateMessageResponse.class)
@JsonDeserialize(as = ImmutableUpdateMessageResponse.class)
@SuppressWarnings("immutables:subtype")
public interface UpdateMessageResponse extends Response {
