...
@Value.Immutable
@JsonSerialize(as = ImmutableReportMessageResponse.class)
@JsonDeserialize(as = ImmutableReportMessageResponse.class)
@SuppressWarnings("immutables:subtype")
public interface ReportMessageResponse extends Response {
}
