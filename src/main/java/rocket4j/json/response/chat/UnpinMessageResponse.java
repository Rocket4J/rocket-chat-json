...
@Value.Immutable
@JsonSerialize(as = ImmutableUnpinMessageResponse.class)
@JsonDeserialize(as = ImmutableUnpinMessageResponse.class)
@SuppressWarnings("immutables:subtype")
public interface UnpinMessageResponse extends Response {
}
