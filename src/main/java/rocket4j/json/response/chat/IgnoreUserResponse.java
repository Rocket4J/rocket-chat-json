...
@Value.Immutable
@JsonSerialize(as = ImmutableIgnoreUserResponse.class)
@JsonDeserialize(as = ImmutableIgnoreUserResponse.class)
@SuppressWarnings("immutables:subtype")
public interface IgnoreUserResponse extends Response {
}
