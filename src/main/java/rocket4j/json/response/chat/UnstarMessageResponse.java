...
@Value.Immutable
@JsonSerialize(as = ImmutableUnstarMessageResponse.class)
@JsonDeserialize(as = ImmutableUnstarMessageResponse.class)
@SuppressWarnings("immutables:subtype")
public interface UnstarMessageResponse extends Response {
}
