...
@Value.Immutable
@JsonSerialize(as = ImmutableGetThreadsListResponse.class)
@JsonDeserialize(as = ImmutableGetThreadsListResponse.class)
@SuppressWarnings("immutables:subtype")
public interface GetThreadsListResponse extends Response, PageData {

    List<ThreadMessageData> threads();
}
