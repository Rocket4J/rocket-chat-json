...
@Value.Immutable
@JsonSerialize(as = ImmutableUnfollowMessageResponse.class)
@JsonDeserialize(as = ImmutableUnfollowMessageResponse.class)
@SuppressWarnings("immutables:subtype")
public interface UnfollowMessageResponse extends Response {
}
