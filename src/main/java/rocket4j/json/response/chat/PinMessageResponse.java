...
@Value.Immutable
@JsonSerialize(as = ImmutablePinMessageResponse.class)
@JsonDeserialize(as = ImmutablePinMessageResponse.class)
@SuppressWarnings("immutables:subtype")
public interface PinMessageResponse extends Response {
