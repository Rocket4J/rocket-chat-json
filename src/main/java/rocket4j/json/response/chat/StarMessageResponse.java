...
@Value.Immutable
@JsonSerialize(as = ImmutableStarMessageResponse.class)
@JsonDeserialize(as = ImmutableStarMessageResponse.class)
@SuppressWarnings("immutables:subtype")
public interface StarMessageResponse extends Response {
}
