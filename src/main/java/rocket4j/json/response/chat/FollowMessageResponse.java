...
@Value.Immutable
@JsonSerialize(as = ImmutableFollowMessageResponse.class)
@JsonDeserialize(as = ImmutableFollowMessageResponse.class)
@SuppressWarnings("immutables:subtype")
public interface FollowMessageResponse extends Response {
}
