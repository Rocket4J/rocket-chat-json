...
@Value.Immutable
@JsonSerialize(as = ImmutableGetSnippetedMessagesResponse.class)
@JsonDeserialize(as = ImmutableGetSnippetedMessagesResponse.class)
@SuppressWarnings("immutables:subtype")
public interface GetSnippetedMessagesResponse extends Response, PageData {
