...
@Value.Immutable
@JsonSerialize(as = ImmutableGetMessageResponse.class)
@JsonDeserialize(as = ImmutableGetMessageResponse.class)
@SuppressWarnings("immutables:subtype")
public interface GetMessageResponse extends Response {
