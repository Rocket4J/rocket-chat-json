...
@Value.Immutable
@JsonSerialize(as = ImmutableGetPinnedMessagesResponse.class)
@JsonDeserialize(as = ImmutableGetPinnedMessagesResponse.class)
@SuppressWarnings("immutables:subtype")
public interface GetPinnedMessagesResponse extends Response, PageData {
