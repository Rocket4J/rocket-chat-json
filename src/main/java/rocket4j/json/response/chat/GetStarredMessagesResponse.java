...
@Value.Immutable
@JsonSerialize(as = ImmutableGetStarredMessagesResponse.class)
@JsonDeserialize(as = ImmutableGetStarredMessagesResponse.class)
@SuppressWarnings("immutables:subtype")
public interface GetStarredMessagesResponse extends Response, PageData {
