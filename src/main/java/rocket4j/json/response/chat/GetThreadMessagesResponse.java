...
@Value.Immutable
@JsonSerialize(as = ImmutableGetThreadMessagesResponse.class)
@JsonDeserialize(as = ImmutableGetThreadMessagesResponse.class)
@SuppressWarnings("immutables:subtype")
public interface GetThreadMessagesResponse extends Response, PageData {

    List<ThreadMessageData> messages();
}
