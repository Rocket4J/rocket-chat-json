...
@Value.Immutable
@JsonSerialize(as = ImmutableGetMentionedMessagesResponse.class)
@JsonDeserialize(as = ImmutableGetMentionedMessagesResponse.class)
@SuppressWarnings("immutables:subtype")
public interface GetMentionedMessagesResponse extends Response, PageData {
