...
@Value.Immutable
@JsonSerialize(as = ImmutableMessagesOtherResponse.class)
@JsonDeserialize(as = ImmutableMessagesOtherResponse.class)
@SuppressWarnings("immutables:subtype")
public interface MessagesOtherResponse extends Response {
