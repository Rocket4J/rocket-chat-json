...
@Value.Immutable
@JsonSerialize(as = ImmutableSaveSettingsResponse.class)
@JsonDeserialize(as = ImmutableSaveSettingsResponse.class)
@SuppressWarnings("immutables:subtype")
public interface SaveSettingsResponse extends Response {
