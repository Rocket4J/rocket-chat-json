...
@Value.Immutable
@JsonSerialize(as = ImmutableUnsetAssetsResponse.class)
@JsonDeserialize(as = ImmutableUnsetAssetsResponse.class)
@SuppressWarnings("immutables:subtype")
public interface UnsetAssetsResponse extends Response {
