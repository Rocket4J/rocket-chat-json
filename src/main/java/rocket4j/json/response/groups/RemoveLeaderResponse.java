...
@Value.Immutable
@JsonSerialize(as = ImmutableRemoveLeaderResponse.class)
@JsonDeserialize(as = ImmutableRemoveLeaderResponse.class)
@SuppressWarnings("immutables:subtype")
public interface RemoveLeaderResponse extends Response {
}
