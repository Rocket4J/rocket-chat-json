...
@Value.Immutable
@JsonSerialize(as = ImmutableAddLeaderResponse.class)
@JsonDeserialize(as = ImmutableAddLeaderResponse.class)
@SuppressWarnings("immutables:subtype")
public interface AddLeaderResponse extends Response {
}
