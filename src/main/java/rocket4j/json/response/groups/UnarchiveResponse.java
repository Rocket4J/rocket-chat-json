...
@Value.Immutable
@JsonSerialize(as = ImmutableUnarchiveResponse.class)
@JsonDeserialize(as = ImmutableUnarchiveResponse.class)
@SuppressWarnings("immutables:subtype")
public interface UnarchiveResponse extends Response {
}
