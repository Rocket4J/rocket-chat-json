...
@Value.Immutable
@JsonSerialize(as = ImmutableSetCustomFieldsResponse.class)
@JsonDeserialize(as = ImmutableSetCustomFieldsResponse.class)
@SuppressWarnings("immutables:subtype")
public interface SetCustomFieldsResponse extends Response {
