...
import rocket4j.json.role.RoomRoleData;

@Value.Immutable
@JsonSerialize(as = ImmutableRolesResponse.class)
@JsonDeserialize(as = ImmutableRolesResponse.class)
@SuppressWarnings("immutables:subtype")
public interface RolesResponse extends Response {

    List<RoomRoleData> roles();
}
