...
@Value.Immutable
@JsonSerialize(as = ImmutableSetDescriptionResponse.class)
@JsonDeserialize(as = ImmutableSetDescriptionResponse.class)
@SuppressWarnings("immutables:subtype")
public interface SetDescriptionResponse extends Response {
