...
@Value.Immutable
@JsonSerialize(as = ImmutableSetAnnouncementResponse.class)
@JsonDeserialize(as = ImmutableSetAnnouncementResponse.class)
@SuppressWarnings("immutables:subtype")
public interface SetAnnouncementResponse extends Response {
