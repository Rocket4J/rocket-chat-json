...
@Value.Immutable
@JsonSerialize(as = ImmutableSetReadOnlyResponse.class)
@JsonDeserialize(as = ImmutableSetReadOnlyResponse.class)
@SuppressWarnings("immutables:subtype")
public interface SetReadOnlyResponse extends Response {
