...
@Value.Immutable
@JsonSerialize(as = ImmutableRemoveOwnerResponse.class)
@JsonDeserialize(as = ImmutableRemoveOwnerResponse.class)
@SuppressWarnings("immutables:subtype")
public interface RemoveOwnerResponse extends Response {
}
