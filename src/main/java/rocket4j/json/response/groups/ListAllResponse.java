...
@Value.Immutable
@JsonSerialize(as = ImmutableListAllResponse.class)
@JsonDeserialize(as = ImmutableListAllResponse.class)
@SuppressWarnings("immutables:subtype")
public interface ListAllResponse extends Response, PageData {

    List<RoomData> groups();
}
