...
@Value.Immutable
@JsonSerialize(as = ImmutableInstantMessageRoomData.class)
@JsonDeserialize(as = ImmutableInstantMessageRoomData.class)
@SuppressWarnings("immutables:subtype")
public interface InstantMessageRoomData extends RoomData {

    //TODO: Find out why this is being provided and what it means.
