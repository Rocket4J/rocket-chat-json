...
@JsonTests
public final class ArchiveResponseTest {

    private final ObjectMapper objectMapper;

    public ArchiveResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("archive-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, ArchiveResponse.class));
    }
}
