...
@JsonTests
public final class RenameResponseTest {

    private final ObjectMapper objectMapper;

    public RenameResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("rename-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, RenameResponse.class));
    }
}
