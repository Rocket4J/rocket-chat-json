...
@JsonTests
public final class DeleteResponseTest {

    private final ObjectMapper objectMapper;

    public DeleteResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("delete-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, DeleteResponse.class));
    }
}
