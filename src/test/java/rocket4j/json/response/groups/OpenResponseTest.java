...
@JsonTests
public final class OpenResponseTest {

    private final ObjectMapper objectMapper;

    public OpenResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("open-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, OpenResponse.class));
    }
}
