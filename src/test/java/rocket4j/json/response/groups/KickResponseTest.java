...
@JsonTests
public final class KickResponseTest {

    private final ObjectMapper objectMapper;

    public KickResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("kick-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, KickResponse.class));
    }
}
