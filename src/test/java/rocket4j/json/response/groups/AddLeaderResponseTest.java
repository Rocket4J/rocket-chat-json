...
@JsonTests
public final class AddLeaderResponseTest {

    private final ObjectMapper objectMapper;

    public AddLeaderResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("add-leader-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, AddLeaderResponse.class));
    }
}
