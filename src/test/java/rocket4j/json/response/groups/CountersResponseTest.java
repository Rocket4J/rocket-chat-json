...
@JsonTests
public final class CountersResponseTest {

    private final ObjectMapper objectMapper;

    public CountersResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("counters-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, CountersResponse.class));
    }
}
