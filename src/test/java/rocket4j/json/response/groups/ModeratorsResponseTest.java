...
@JsonTests
public final class ModeratorsResponseTest {

    private final ObjectMapper objectMapper;

    public ModeratorsResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("moderators-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, ModeratorsResponse.class));
    }
}
