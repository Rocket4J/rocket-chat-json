...
@JsonTests
public final class MembersResponseTest {

    private final ObjectMapper objectMapper;

    public MembersResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("members-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, MembersResponse.class));
    }
}
