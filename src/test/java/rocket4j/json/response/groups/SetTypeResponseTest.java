...
@JsonTests
public final class SetTypeResponseTest {

    private final ObjectMapper objectMapper;

    public SetTypeResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("set-type-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, SetTypeResponse.class));
    }
}
