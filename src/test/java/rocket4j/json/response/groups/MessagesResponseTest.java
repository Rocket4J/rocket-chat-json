...
@JsonTests
public final class MessagesResponseTest {

    private final ObjectMapper objectMapper;

    public MessagesResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("messages-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, MessagesResponse.class));
    }
}
