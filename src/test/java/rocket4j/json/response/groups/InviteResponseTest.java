...
@JsonTests
public final class InviteResponseTest {

    private final ObjectMapper objectMapper;

    public InviteResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("invite-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, InviteResponse.class));
    }
}
