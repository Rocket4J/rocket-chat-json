...
@JsonTests
public final class SetPurposeResponseTest {

    private final ObjectMapper objectMapper;

    public SetPurposeResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("set-purpose-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, SetPurposeResponse.class));
    }
}
