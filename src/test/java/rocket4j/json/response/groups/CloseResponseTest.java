...
@JsonTests
public final class CloseResponseTest {

    private final ObjectMapper objectMapper;

    public CloseResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("close-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, CloseResponse.class));
    }
}
