...
@JsonTests
public final class ListAllResponseTest {

    private final ObjectMapper objectMapper;

    public ListAllResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("list-all-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, ListAllResponse.class));
    }
}
