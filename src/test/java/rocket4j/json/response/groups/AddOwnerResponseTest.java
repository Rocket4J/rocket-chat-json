...
@JsonTests
public final class AddOwnerResponseTest {

    private final ObjectMapper objectMapper;

    public AddOwnerResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("add-owner-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, AddOwnerResponse.class));
    }
}
