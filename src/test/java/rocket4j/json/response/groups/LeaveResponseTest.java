...
@JsonTests
public final class LeaveResponseTest {

    private final ObjectMapper objectMapper;

    public LeaveResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("leave-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, LeaveResponse.class));
    }
}
