...
@JsonTests
public final class RolesResponseTest {

    private final ObjectMapper objectMapper;

    public RolesResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("roles-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, RolesResponse.class));
    }
}
