...
@JsonTests
public final class HistoryResponseTest {

    private final ObjectMapper objectMapper;

    public HistoryResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("history-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, HistoryResponse.class));
    }
}
