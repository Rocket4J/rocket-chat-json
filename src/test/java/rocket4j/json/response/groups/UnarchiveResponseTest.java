...
@JsonTests
public final class UnarchiveResponseTest {

    private final ObjectMapper objectMapper;

    public UnarchiveResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("unarchive-example-result.json") final String json) {
        assertDoesNotThrow(() -> this.objectMapper.readValue(json, UnarchiveResponse.class));
    }
}
