...
@JsonTests
public final class SetAssetsResponseTest {

    private final ObjectMapper objectMapper;

    public SetAssetsResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("set-assets-example-result.json") final String json) {
