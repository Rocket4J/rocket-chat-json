...
@JsonTests
public final class RunResponseTest {

    private final ObjectMapper objectMapper;

    public RunResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("run-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, RunResponse.class));
    }
}
