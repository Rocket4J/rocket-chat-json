...
@JsonTests
public final class SaveSettingsResponseTest {

    private final ObjectMapper objectMapper;

    public SaveSettingsResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("save-settings-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, SaveSettingsResponse.class));
    }
}
