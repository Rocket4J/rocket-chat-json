...
@JsonTests
public final class UpdateTimeoutResponseTest {

    private final ObjectMapper objectMapper;

    public UpdateTimeoutResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("update-timeout-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, UpdateTimeoutResponse.class));
    }
}
