...
@JsonTests
public final class RoomsResponseTest {

    private final ObjectMapper objectMapper;

    public RoomsResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("rooms-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, RoomsResponse.class));
    }
}
