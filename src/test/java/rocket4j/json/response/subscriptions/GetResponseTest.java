...
@JsonTests
public final class GetResponseTest {

    private final ObjectMapper objectMapper;

    public GetResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("get-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, GetResponse.class));
    }
}
