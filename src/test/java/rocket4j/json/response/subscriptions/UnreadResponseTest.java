...
@JsonTests
public final class UnreadResponseTest {

    private final ObjectMapper objectMapper;

    public UnreadResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("unread-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, UnreadResponse.class));
    }
}
