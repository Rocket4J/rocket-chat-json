...
@JsonTests
public final class GetOneResponseTest {

    private final ObjectMapper objectMapper;

    public GetOneResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("get-one-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, GetOneResponse.class));
    }
}
