...
@JsonTests
public final class ReadResponseTest {

    private final ObjectMapper objectMapper;

    public ReadResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("read-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, ReadResponse.class));
    }
}
