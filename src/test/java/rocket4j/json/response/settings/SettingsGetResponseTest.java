...
@JsonTests
public final class SettingsGetResponseTest {

    private final ObjectMapper objectMapper;

    public SettingsGetResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("settings-get-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, SettingsGetResponse.class));
    }
}
