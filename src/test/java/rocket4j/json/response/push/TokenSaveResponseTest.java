...
@JsonTests
public final class TokenSaveResponseTest {

    private final ObjectMapper objectMapper;

    public TokenSaveResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("token-save-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, TokenSaveResponse.class));
    }
}
