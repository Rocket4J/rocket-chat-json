...
@JsonTests
public final class TokenDeleteResponseTest {

    private final ObjectMapper objectMapper;

    public TokenDeleteResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("token-delete-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, TokenDeleteResponse.class));
    }
}
