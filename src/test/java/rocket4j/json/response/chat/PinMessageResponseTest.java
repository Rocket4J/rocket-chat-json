...
@JsonTests
public final class PinMessageResponseTest {

    private final ObjectMapper objectMapper;

    public PinMessageResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("pin-message-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, PinMessageResponse.class));
    }
}
