...
@JsonTests
public final class GetMessageResponseTest {

    private final ObjectMapper objectMapper;

    public GetMessageResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("get-message-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, GetMessageResponse.class));
    }
}
