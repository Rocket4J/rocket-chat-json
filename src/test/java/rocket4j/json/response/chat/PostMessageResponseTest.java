...
@JsonTests
public final class PostMessageResponseTest {

    private final ObjectMapper objectMapper;

    public PostMessageResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("post-message-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, PostMessageResponse.class));
    }
}
