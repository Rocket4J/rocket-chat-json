...
@JsonTests
public final class StarMessageResponseTest {

    private final ObjectMapper objectMapper;

    public StarMessageResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("star-message-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, StarMessageResponse.class));
    }
}
