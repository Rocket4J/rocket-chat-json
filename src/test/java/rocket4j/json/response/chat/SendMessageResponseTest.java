...
@JsonTests
public final class SendMessageResponseTest {

    private final ObjectMapper objectMapper;

    public SendMessageResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("send-message-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, SendMessageResponse.class));
    }
}
