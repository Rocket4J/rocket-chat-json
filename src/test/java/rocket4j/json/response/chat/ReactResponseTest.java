...
@JsonTests
public final class ReactResponseTest {

    private final ObjectMapper objectMapper;

    public ReactResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("react-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, ReactResponse.class));
    }
}
