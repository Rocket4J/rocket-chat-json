...
public final class SearchResponseTest {
    ...
    public SearchResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("search-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, SearchResponse.class));
    }
}
