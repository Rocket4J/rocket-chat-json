...
@JsonTests
public final class IgnoreUserResponseTest {

    private final ObjectMapper objectMapper;

    public IgnoreUserResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("ignore-user-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, IgnoreUserResponse.class));
    }
}
