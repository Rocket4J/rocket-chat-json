...
@JsonTests
public final class ListEveryoneResponseTest {

    private final ObjectMapper objectMapper;

    public ListEveryoneResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("list-everyone-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, ListEveryoneResponse.class));
    }
}
