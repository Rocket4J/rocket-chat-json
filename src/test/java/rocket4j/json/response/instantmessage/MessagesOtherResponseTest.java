...
@JsonTests
public final class MessagesOtherResponseTest {

    private final ObjectMapper objectMapper;

    public MessagesOtherResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("messages-other-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, MessagesOtherResponse.class));
    }
}
