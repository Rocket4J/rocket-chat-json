...
@JsonTests
public final class FavoriteResponseTest {

    private final ObjectMapper objectMapper;

    public FavoriteResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("favorite-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, FavoriteResponse.class));
    }
}
