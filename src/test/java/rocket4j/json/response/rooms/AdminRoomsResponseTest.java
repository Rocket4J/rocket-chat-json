...
@JsonTests
public final class AdminRoomsResponseTest {

    private final ObjectMapper objectMapper;

    public AdminRoomsResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("admin-rooms-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, AdminRoomsResponse.class));
    }
}
