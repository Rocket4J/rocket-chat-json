...
@JsonTests
public final class StatisticsResponseTest {

    private final ObjectMapper objectMapper;

    public StatisticsResponseTest(final ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    @Test
    void deserializeInfoResponseTest(@JsonFile("statistics-example-result.json") final String json) {
        assertDoesNotThrow(() -> objectMapper.readValue(json, StatisticsResponse.class));
    }
}
